...
class TransColisCgDla(models.Model):
    ...
    depart_transport = models.CharField(max_length=12, blank=True, null=True, verbose_name='Départ du Transport')
...
#                                             SCIAGES                                           #
#################################################################################################
#                                     Transports Betou Bangui                                   #
#################################################################################################

class TransColisCgBangui(models.Model):
    id_trans_colis_cg_bangui = models.AutoField(primary_key=True)
    code_trans = models.IntegerField(unique=True, verbose_name='Code Transport')
    num_trans_colis_man = models.IntegerField(blank=True, null=True, verbose_name='Numéro de Transport')
    date_trans_colis = models.DateField(null=False,verbose_name="Date de Transport")
    depart_transport = models.CharField(max_length=12, blank=True, null=True, verbose_name='Départ du Transport')
...
class TransColisCgBanguiDet(models.Model):
    id_trans_colis_cg_bangui_det = models.AutoField(primary_key=True)
    code_trans = models.IntegerField(blank=True, null=True, verbose_name='Code Transport')
    essence = models.ForeignKey(I_Essences, on_delete=models.CASCADE, unique=False, db_column='essence')
    num_colis = models.CharField(max_length=15, blank=True, null=True, verbose_name='Numéro de Colis')
    epaisseur = models.IntegerField(blank=True, null=True, verbose_name='Epaisseur')
    ...
    code_specif_douane = models.CharField(max_length=12, blank=True, null=True, verbose_name='Code Spécif Douane')
    destinataire = models.CharField(max_length=50, blank=True, null=True, verbose_name='Destinataire')
    id_trans_colis_cg_bangui = models.ForeignKey(TransColisCgBangui, on_delete=models.CASCADE, unique=False, db_column='id_trans_colis_cg_bangui')
...
#################################################################################################
#                                  Spécifications Betou Bangui                                  #
#################################################################################################

class SpecifColisCgBangui(models.Model):
    id_specif_colis_cg_bangui = models.AutoField(primary_key=True)
    num_specif = models.IntegerField(blank=True, null=True, verbose_name='Numéro Spécification')
    num_contrat = models.ForeignKey(I_Contrats, on_delete=models.CASCADE, unique=False, db_column='num_contrat')
    code_specif = models.CharField(max_length=1, blank=True, null=True, verbose_name='Code Spécification')
    code_specif_douane = models.CharField(max_length=12, blank=True, null=True, verbose_name='Code Spécif Douane')
...
class SpecifColisCgBanguiDet(models.Model):
    id_specif_colis_cg_dla_det = models.AutoField(primary_key=True)
    num_colis = models.CharField(max_length=15, blank=True, null=True, verbose_name='Numéro de Colis')
    epaisseur = models.IntegerField(blank=True, null=True, verbose_name='Epaisseur')
    #longueur = models.IntegerField(blank=True, null=True, verbose_name='Longueur')
    ...
    certifie = models.BooleanField(blank=True, null=True, verbose_name='Certifié OLB')
    num_specif = models.IntegerField(blank=True, null=True, verbose_name='Numéro Spécification')
    id_specif_colis_cg_bangui = models.ForeignKey(SpecifColisCgBangui, on_delete=models.CASCADE, unique=False, db_column='id_specif_colis_cg_bangui')
...
#                                             GRUMES                                            #
#################################################################################################
#                                     Transport Betou Bangui                                    #
#################################################################################################

class TransGrumesCgBangui(models.Model):
    id_trans_grumes_cg_bangui = models.AutoField(primary_key=True)
    code_trans = models.IntegerField(blank=True, null=True, verbose_name='Code Transport')
    num_trans_grumes_man = models.IntegerField(blank=True, null=True, verbose_name='Numéro de Transport')
    date_trans_grumes = models.DateField(null=False,verbose_name="Date de Transport")
    dest_transport = models.CharField(max_length=12, blank=True, null=True, verbose_name='Destination du Transport')
...
class TransGrumesCgBanguiDet(models.Model):
    id_trans_grumes_cg_bangui_det = models.AutoField(primary_key=True)
    code_trans = models.IntegerField(blank=True, null=True, verbose_name='Code Transport')
    essence = models.ForeignKey(I_Essences, on_delete=models.CASCADE, unique=False, db_column='essence')
    num_bille = models.CharField(max_length=15, blank=True, null=True, verbose_name='Numéro de Bille')
    longueur = models.IntegerField(blank=True, null=True, verbose_name='Longueur')
    ...
    code_specif_douane = models.CharField(max_length=12, blank=True, null=True, verbose_name='Code Spécif Douane')
    destinataire = models.CharField(max_length=50, blank=True, null=True, verbose_name='Destinataire')
    id_trans_grumes_cg_bangui = models.ForeignKey(TransGrumesCgBangui, on_delete=models.CASCADE, unique=False, db_column='id_trans_grumes_cg_bangui')
...
class SpecifGrumesCgBangui(models.Model):
    id_specif_grumes_cg_bangui = models.AutoField(primary_key=True)
    num_specif = models.IntegerField(blank=True, null=True, verbose_name='Numéro Spécification')
    num_contrat = models.ForeignKey(I_Contrats_Gr, on_delete=models.CASCADE, unique=False, db_column='num_contrat_gr')
    code_specif = models.CharField(max_length=1, blank=True, null=True, verbose_name='Code Spécification')
    code_specif_douane = models.CharField(max_length=12, blank=True, null=True, verbose_name='Code Spécif Douane')
...
class SpecifGrumesCgBanguiDet(models.Model):
    id_specif_grumes_cg_bangui_det = models.AutoField(primary_key=True)
    num_bille = models.CharField(max_length=15, blank=True, null=True, verbose_name='Numéro de Bille')
    longueur = models.IntegerField(blank=True, null=True, verbose_name='Longueur')
    diametre = models.IntegerField(blank=True, null=True, verbose_name='Diamètre')
    cubage = models.DecimalField(max_digits=6, decimal_places=3, blank=True, null=True, verbose_name='Cubage')
    ...
    certifie = models.BooleanField(blank=True, null=True, verbose_name='Certifié OLB')
    num_specif = models.IntegerField(blank=True, null=True, verbose_name='Numéro Spécification')
    id_specif_grumes_cg_bangui = models.ForeignKey(SpecifGrumesCgBangui, on_delete=models.CASCADE, unique=False, db_column='id_specif_grumes_cg_bangui')
...
#                                             SCIAGES                                           #
#################################################################################################
#                                   Transports Betou Brazzaville                                #
#################################################################################################

class TransColisCgBrazza(models.Model):
    id_trans_colis_cg_brazza = models.AutoField(primary_key=True)
    code_trans = models.IntegerField(unique=True, verbose_name='Code Transport')
    num_trans_colis_man = models.IntegerField(blank=True, null=True, verbose_name='Numéro de Transport')
    date_trans_colis = models.DateField(null=False,verbose_name="Date de Transport")
    depart_transport = models.CharField(max_length=12, blank=True, null=True, verbose_name='Départ du Transport')
...
class TransColisCgBrazzaDet(models.Model):
    id_trans_colis_cg_brazza_det = models.AutoField(primary_key=True)
    code_trans = models.IntegerField(blank=True, null=True, verbose_name='Code Transport')
    essence = models.ForeignKey(I_Essences, on_delete=models.CASCADE, unique=False, db_column='essence')
    num_colis = models.CharField(max_length=15, blank=True, null=True, verbose_name='Numéro de Colis')
    epaisseur = models.IntegerField(blank=True, null=True, verbose_name='Epaisseur')
    ...
    code_specif_douane = models.CharField(max_length=12, blank=True, null=True, verbose_name='Code Spécif Douane')
    destinataire = models.CharField(max_length=50, blank=True, null=True, verbose_name='Destinataire')
    id_trans_colis_cg_brazza = models.ForeignKey(TransColisCgBrazza, on_delete=models.CASCADE, unique=False, db_column='id_trans_colis_cg_brazza')
...
#################################################################################################
#                                  Spécifications Betou Brazzaville                             #
#################################################################################################

class SpecifColisCgBrazza(models.Model):
    id_specif_colis_cg_brazza = models.AutoField(primary_key=True)
    num_specif = models.IntegerField(blank=True, null=True, verbose_name='Numéro Spécification')
    num_contrat = models.ForeignKey(I_Contrats, on_delete=models.CASCADE, unique=False, db_column='num_contrat')
    code_specif = models.CharField(max_length=1, blank=True, null=True, verbose_name='Code Spécification')
    code_specif_douane = models.CharField(max_length=12, blank=True, null=True, verbose_name='Code Spécif Douane')
...
class SpecifColisCgBrazzaDet(models.Model):
    id_specif_colis_cg_brazza_det = models.AutoField(primary_key=True)
    num_colis = models.CharField(max_length=15, blank=True, null=True, verbose_name='Numéro de Colis')
    epaisseur = models.IntegerField(blank=True, null=True, verbose_name='Epaisseur')
    #longueur = models.IntegerField(blank=True, null=True, verbose_name='Longueur')
    nbre_elts = models.IntegerField(blank=True, null=True, verbose_name='Nombre Eléments')
    ...
    certifie = models.BooleanField(blank=True, null=True, verbose_name='Certifié OLB')
    num_specif = models.IntegerField(blank=True, null=True, verbose_name='Numéro Spécification')
    id_specif_colis_cg_brazza = models.ForeignKey(SpecifColisCgBrazza, on_delete=models.CASCADE, unique=False, db_column='id_specif_colis_cg_brazza')
...
class TransGrumesCgBrazza(models.Model):
    id_trans_grumes_cg_brazza = models.AutoField(primary_key=True)
    code_trans = models.IntegerField(blank=True, null=True, verbose_name='Code Transport')
    num_trans_grumes_man = models.IntegerField(blank=True, null=True, verbose_name='Numéro de Transport')
    date_trans_grumes = models.DateField(null=False,verbose_name="Date de Transport")
    dest_transport = models.CharField(max_length=12, blank=True, null=True, verbose_name='Destination du Transport')
...
class TransGrumesCgBrazzaDet(models.Model):
    id_trans_grumes_cg_brazza_det = models.AutoField(primary_key=True)
    code_trans = models.IntegerField(blank=True, null=True, verbose_name='Code Transport')
    essence = models.ForeignKey(I_Essences, on_delete=models.CASCADE, unique=False, db_column='essence')
    num_bille = models.CharField(max_length=15, blank=True, null=True, verbose_name='Numéro de Bille')
    longueur = models.IntegerField(blank=True, null=True, verbose_name='Longueur')
    ...
    code_specif_douane = models.CharField(max_length=12, blank=True, null=True, verbose_name='Code Spécif Douane')
    destinataire = models.CharField(max_length=50, blank=True, null=True, verbose_name='Destinataire')
    id_trans_grumes_cg_brazza = models.ForeignKey(TransGrumesCgBrazza, on_delete=models.CASCADE, unique=False, db_column='id_trans_grumes_cg_brazza')
...
class SpecifGrumesCgBrazza(models.Model):
    id_specif_grumes_cg_brazza = models.AutoField(primary_key=True)
    num_specif = models.IntegerField(blank=True, null=True, verbose_name='Numéro Spécification')
    num_contrat = models.ForeignKey(I_Contrats_Gr, on_delete=models.CASCADE, unique=False, db_column='num_contrat_gr')
    code_specif = models.CharField(max_length=1, blank=True, null=True, verbose_name='Code Spécification')
    code_specif_douane = models.CharField(max_length=12, blank=True, null=True, verbose_name='Code Spécif Douane')
...
class SpecifGrumesCgBrazzaDet(models.Model):
    id_specif_grumes_cg_brazza_det = models.AutoField(primary_key=True)
    num_bille = models.CharField(max_length=15, blank=True, null=True, verbose_name='Numéro de Bille')
    longueur = models.IntegerField(blank=True, null=True, verbose_name='Longueur')
    diametre = models.IntegerField(blank=True, null=True, verbose_name='Diamètre')
    cubage = models.DecimalField(max_digits=6, decimal_places=3, blank=True, null=True, verbose_name='Cubage')
    ...
    certifie = models.BooleanField(blank=True, null=True, verbose_name='Certifié OLB')
    num_specif = models.IntegerField(blank=True, null=True, verbose_name='Numéro Spécification')
    id_specif_grumes_cg_brazza = models.ForeignKey(SpecifGrumesCgBrazza, on_delete=models.CASCADE, unique=False, db_column='id_specif_grumes_cg_brazza')
