...
urlpatterns = [
    ...
    # path Transport Colis Bétou vers Douala
    path('transport/sciages/', TransportListView.as_view(), name='transport_list'),
    path('transport/sciages/codetrans/<slug:code_trans>/', TranspCodeTransListView.as_view(), name='transport_codetrans'),
    path('transport/sciages/detail/<slug:code_trans>/', TransportDetListView.as_view(), name='detail_transport'),
    path('transport/sciages/reception/', TransportaRecepListView.as_view(), name='transport_a_recep'),
